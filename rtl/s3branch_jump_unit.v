...
if (Jump_E) begin
    pc_sel = 1'b1;
    case(opcode_E) 
        7'b1101111: next_pc = pc_E + immediate_E; // jal
        7'b1100111: next_pc = (rs1_data_E + immediate_E) & 32'hFFFFFFFE; // jalr
        default: next_pc = pc_E + 32'd4; // Default case for unsupported jump
    endcase
end
else if (Branch_E) begin
    if (take_branch) begin
        pc_sel  = 1'b1;
        next_pc = pc_E + immediate_E;
    end
end
end
endmodule
